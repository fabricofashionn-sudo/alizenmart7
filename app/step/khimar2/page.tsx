  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans antialiased">
      ...
      >
        ...
        >
          <path d="M16.004 2C8.28 2 2 8.28 2 16.004c0 2.478.655 4.907 1.902 7.043L2 30l7.145-1.875A13.96 13.96 0 0 0 16.004 30C23.72 30 30 23.72 30 16.004 30 8.28 23.72 2 16.004 2zm0 25.6a11.56 11.56 0 0 1-5.9-1.614l-.424-.252-4.24 1.113 1.133-4.138-.276-.437A11.56 11.56 0 0 1 4.4 16.004C4.4 9.604 9.604 4.4 16.004 4.4c6.396 0 11.596 5.204 11.596 11.604C27.6 22.4 22.4 27.6 16.004 27.6zm6.353-8.672c-.347-.175-2.055-1.015-2.374-1.13-.32-.118-.552-.175-.784.175-.232.347-.9 1.13-1.103 1.363-.203.232-.406.26-.753.087-.347-.175-1.466-.54-2.793-1.724-1.032-.92-1.728-2.057-1.931-2.404-.203-.347-.022-.535.153-.708.157-.155.347-.406.521-.609.174-.203.232-.347.347-.579.116-.232.058-.435-.03-.609-.087-.175-.784-1.89-1.074-2.588-.283-.68-.57-.587-.784-.598l-.668-.012c-.232 0-.609.087-.928.434-.32.347-1.218 1.19-1.218 2.902 0 1.712 1.247 3.368 1.42 3.6.175.232 2.454 3.748 5.948 5.254.832.36 1.48.574 1.986.735.834.266 1.594.228 2.194.138.67-.1 2.055-.84 2.345-1.652.29-.812.29-1.508.203-1.652-.087-.143-.32-.23-.667-.405z"/>
        </svg>
        <span className="text-sm font-bold whitespace-nowrap">WhatsApp করুন</span>
      </a>
    </div>
  );
}
