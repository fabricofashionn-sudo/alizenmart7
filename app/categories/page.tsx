          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3 md:gap-4">
            {categories.map((category, index) => (
              <Link
                ...
                className="bg-white p-3 md:p-4 rounded-xl border border-gray-100 hover:border-[#1a80c2]/30 hover:shadow-lg transition-all duration-300 flex flex-col items-center justify-center aspect-square group"
              >
